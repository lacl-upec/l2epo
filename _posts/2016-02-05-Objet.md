...
- mettre en valeur les fonctionalités
...
Exemple:
    ...
    class Prog {
      public static void main(String[] args) {
        ...
        System.out.println("Parc: "+voiture.identification()+" et "+voiture2.identification());
      }
    }
...
Quannd il n'y a pas ambigüité avec les paramètres ou variables locales des méthodes ou constructeurs, on peut ommettre `this.` (déconseillé au début car cela fait des erreurs curieuses).
...
Exemple :
    ...
    class ObjetPayant() {
      ...
      public void paye(double compteur) {
...
On ne rend publique que ce qui vraiment utilisé par d'autre objets
