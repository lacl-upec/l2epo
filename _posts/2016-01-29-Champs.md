...
Bien évidemment, pour utiliser cet objet, il faut soit stocker ça référence dans une variable :

        Chrono chrono = new Chrono();
        
Soit le passer à une fonction (pas d'exemple pour le moment).
...
> On peut très bien créer une classe sans champs juste pour cela
